...
pub fn main_menu() -> UIManager {
    ...
    main_menu.add_button("Against yourself", Button::new_center_width(0.2, 0.3, 0.1, "Against yourself", BLUE, LIGHTGRAY));
    main_menu.add_button("Against bot", Button::new_center_width(0.35, 0.3, 0.1, "Against bot", BLUE, LIGHTGRAY));
    main_menu.add_button("Online", Button::new_center_width(0.5, 0.3, 0.1, "Online", BLUE, LIGHTGRAY));
    main_menu.add_button("Quit", Button::new(0.83, 0.0, 0.17, 0.08, "Quit Chess", BLUE, RED));
...
pub fn against_yourself() -> UIManager {
    ...
    against_yourself.add_button("Reset", Button::new(0.7, 0.2, 0.055, 0.05, "reset", BLUE, RED));
    against_yourself.add_button("Flip", Button::new(0.7, 0.1, 0.15, 0.05, "flip board", BLUE, GRAY));
